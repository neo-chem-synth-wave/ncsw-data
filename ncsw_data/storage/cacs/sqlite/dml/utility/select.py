""" The ``ncsw_data.storage.cacs.sqlite.dml.utility`` package ``select`` module. """
...
class CaCSSQLiteDatabaseSelectUtility:
    ...
    def construct_workbench_compound_select_statement(
        ...
        if wc_is_building_block is not None:
            return wc_select_statement.where(
                CaCSSQLiteDatabaseModelWorkbenchCompound.is_building_block == wc_is_building_block
            )
    ...
    ) -> Select[ReversedSynthesisRouteTuple]:
        """
